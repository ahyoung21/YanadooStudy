			...
			<div className="inner-col">
				...
				<div className="footer-nav-menu">
					<dl>
						...
						<dd><a href="#;">1:1 문의하기</a></dd>
					</dl>
					<dl>
						<dt>카카오톡 상담</dt>
						<dd><a href="#;">&#64;야나두 친구추가</a></dd>
					</dl>
					<dl>
						<dt>제휴 및 단체수강 문의</dt>
						<dd><a href="#;">제휴문의</a></dd>
						<dd><a href="#;">단체 수강 문의</a></dd>
					</dl>
				</div>
				<div className="footer-info">
					<strong>무엇을 도와드릴까요?</strong>
					<a href="tel:1600-0563" className="tel">1600.0563</a>
				...
				<p>
					...
					사업자등록번호 129-86-23477 &middot; 통신판매업 신고번호 제2018-서울강남-02139호<br />
					대표 김정수, 김민철 &middot; 개인정보보호 책임자 정호용<br />
					주소 서울시 강남구 영동대로 96길 26, 3, 4층	&#40;삼성동, Place 1&#41;<br />
